...
urlpatterns = [
    ...
    path('documentation/models/', views.docs_models, name='documentation_models'),
    path('documentation/models/signature', views.docs_models_signature, name='documentation_models_signature'),
