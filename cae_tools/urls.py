...
urlpatterns = [
    ...
    path('css_examples/forms', views.css_forms, name='css_forms_base'),
    path('css_examples/forms/default_fields', views.css_forms_default_fields, name='css_forms_default_fields'),
    path('css_examples/forms/custom_fields', views.css_forms_custom_fields, name='css_forms_custom_fields'),
    path('css_examples/forms/other', views.css_forms_misc, name='css_forms_misc'),
