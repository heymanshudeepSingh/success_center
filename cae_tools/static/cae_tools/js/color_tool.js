...
var _color_adjustment = _interopRequireDefault(require("./components/color_adjustment"));

var _color_selection = _interopRequireDefault(require("./components/color_selection"));

var _wmu_color_display = _interopRequireDefault(require("./components/wmu_color_display"));

var _color_functions = require("./components/color_functions");
...
var ColorTool = /*#__PURE__*/function (_React$Component) {
  _inherits(ColorTool, _React$Component);

  var _super = _createSuper(ColorTool);
  ...
  function ColorTool(props) {
    ...
    _this.handleHexChange = _this.handleHexChange.bind(_assertThisInitialized(_this));
    _this.handleRgbChange = _this.handleRgbChange.bind(_assertThisInitialized(_this));
    _this.handleHslChange = _this.handleHslChange.bind(_assertThisInitialized(_this));
    return _this;
  }
  /**
  ...
  _createClass(ColorTool, [{
    ...
    value: function render() {
      return /*#__PURE__*/React.createElement("div", {
        className: "center"
      }, /*#__PURE__*/React.createElement(_wmu_color_display["default"], {
        setParentColor: this.setColor
      }), /*#__PURE__*/React.createElement(_color_selection["default"], {
      ...
      }), /*#__PURE__*/React.createElement(_color_adjustment["default"], {
        hex_value: this.state.hex_value,
        rgb_value: this.state.rgb_value,
        hsl_value: this.state.hsl_value,
        setParentColor: this.setColor
  ...
  return ColorTool;
}(React.Component); // Start of React logic.


function App() {
  return /*#__PURE__*/React.createElement(ColorTool, null);
} // Render to page.


ReactDOM.render(App(), document.getElementById('react-root'));

},{"./components/color_adjustment":2,"./components/color_functions":5,"./components/color_selection":6,"./components/wmu_color_display":7}],2:[function(require,module,exports){
"use strict";
...
var _color_display = _interopRequireDefault(require("./color_display"));
...
var ColorLine = /*#__PURE__*/function (_React$Component) {
  _inherits(ColorLine, _React$Component);

  var _super = _createSuper(ColorLine);
  ...
  _createClass(ColorLine, [{
    ...
    value: function render() {
      return /*#__PURE__*/React.createElement("div", {
        id: "color-adjustment"
      }, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(_color_display["default"], {
        title: "0% Sat",
      ...
      }), /*#__PURE__*/React.createElement(_color_display["default"], {
        title: "10% Sat",
...
var _default = ColorLine;
exports["default"] = _default;

},{"./color_display":3,"./color_functions":5}],3:[function(require,module,exports){
"use strict";
...
var ColorDisplay = /*#__PURE__*/function (_React$Component) {
  _inherits(ColorDisplay, _React$Component);

  var _super = _createSuper(ColorDisplay);
  ...
  _createClass(ColorDisplay, [{
    ...
    value: function render() {
      ...
      var rgb_value = null;
      var hsl_value = null;
      var null_value = false; // Get state from props.
      ...
      return /*#__PURE__*/React.createElement("div", {
        ...
        onClick: function onClick() {
          return _this.handleClick(hex_value);
        }
      }), /*#__PURE__*/React.createElement("h5", null, this.props.title)), /*#__PURE__*/React.createElement("p", null, "Hex: ", hex_value), /*#__PURE__*/React.createElement("p", null, "RGB: ", rgb_value[0], ", ", rgb_value[1], ", ", rgb_value[2]), /*#__PURE__*/React.createElement("p", null, "HSL: ", hsl_value[0], ", ", hsl_value[1], ", ", hsl_value[2]));
    }
  }]);
...
var _default = ColorDisplay;
exports["default"] = _default;

},{"./color_functions":5}],4:[function(require,module,exports){
"use strict";
...
var ColorEdit = /*#__PURE__*/function (_React$Component) {
  _inherits(ColorEdit, _React$Component);

  var _super = _createSuper(ColorEdit);
  ...
  _createClass(ColorEdit, [{
    ...
    value: function render() {
      return /*#__PURE__*/React.createElement("div", {
        ...
        className: "color-box",
        style: {
          backgroundColor: this.props.hex_value
        }
      }), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("p", null, "Hex Value:"), /*#__PURE__*/React.createElement("input", {
        type: "text",
        value: this.props.hex_display,
        onChange: this.props.handleHexChange
      })), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("p", null, "Rgb Value:"), /*#__PURE__*/React.createElement("input", {
        type: "text",
        value: this.props.rgb_display,
        onChange: this.props.handleRgbChange
      })), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("p", null, "Hsl Value:"), /*#__PURE__*/React.createElement("input", {
        type: "text",
        value: this.props.hsl_display,
        onChange: this.props.handleHslChange
      })));
    }
  }]);
...
},{"./color_functions":5}],5:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.color_calc = exports.color_parse = void 0;
...
var color_parse = {
  ...
  parse_rgb_string: function parse_rgb_string(rgb_value) {
    ...
    if (Array.isArray(rgb_value)) {
      ...
      if (rgb_value[0] == '(') {
        ...
        var rgb_array = rgb_value.substring(4, rgb_value.length - 1).split(', ').map(Number); // Try again if no spaces were present.
        ...
        var rgb_array = rgb_value.split(', ').map(Number); // Try again if no spaces were present.
  ...
  parse_hsl_string: function parse_hsl_string(hsl_value) {
    ...
    if (Array.isArray(hsl_value)) {
      ...
      if (hsl_value[0] == '(') {
        // Found string. Split to array.
        var hsl_array = hsl_value.substring(4, hsl_value.length - 1).split(', ').map(Number); // Try again if no spaces were present.
        ...
        // Found string. Split to array.
        var hsl_array = hsl_value.split(', ').map(Number); // Try again if no spaces were present.
...
exports.color_parse = color_parse;
var color_calc = {
  /**
  ...
  convert_hex_to_rgb: function convert_hex_to_rgb(hex_value) {
    ...
    var blue = parseInt(hex_value.slice(5, 7), 16); // var rgb_value = 'rgb(' + red + ', ' + green + ', ' + blue + ')';

    var rgb_value = [red, green, blue]; // Print and return results.
  ...
  convert_rgb_to_hex: function convert_rgb_to_hex(rgb_value) {
    var print_result = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
    // Parse values.
    var rgb_array = color_parse.parse_rgb_string(rgb_value); // Check that values were parsed properly.

    if (rgb_array != null) {
      // Convert values.
      var red = rgb_array[0].toString(16);
      var green = rgb_array[1].toString(16);
      var blue = rgb_array[2].toString(16); // Pad with 0 if hex value is only one character long.
      ...
      hex_value = '#' + red + green + blue; // Print and return results.
  ...
  convert_rgb_to_hsl: function convert_rgb_to_hsl(rgb_value) {
    ...
    var blue = rgb_array[2] / 255; // Convert values.
    ...
    hsl_value = [hue, saturation, lightness]; // Print and return results.
  ...
  convert_hsl_to_rgb: function convert_hsl_to_rgb(hsl_value) {
    ...
    var lightness = hsl_array[2]; // Convert values back to between 0 and 1, if not already.
    ...
    rgb_value = [red, green, blue]; // Print and return results.
  ...
  convert_hex_to_hsl: function convert_hex_to_hsl(hex_value) {
    ...
    var hsl_value = convert_rgb_to_hsl(rgb_value); // Print and return results.
  ...
  convert_hsl_to_hex: function convert_hsl_to_hex(hsl_value) {
    ...
    var hex_value = convert_rgb_to_hex(rgb_value); // Print and return results.
  ...
  adjust_color_hue: function adjust_color_hue(old_color, desired_hue) {
    ...
    var new_color = null; // Validate old color as HSL array.
...
var _color_edit = _interopRequireDefault(require("./color_edit"));
...
var ColorSelection = /*#__PURE__*/function (_React$Component) {
  _inherits(ColorSelection, _React$Component);

  var _super = _createSuper(ColorSelection);
  ...
  _createClass(ColorSelection, [{
    ...
    value: function render() {
      return /*#__PURE__*/React.createElement("div", {
        id: "color-selection"
      }, /*#__PURE__*/React.createElement(_color_edit["default"], {
        title: "Primary",
        hex_value: this.props.hex_value,
        rgb_value: this.props.rgb_value,
        hsl_value: this.props.hsl_value,
...
var _default = ColorSelection;
exports["default"] = _default;

},{"./color_edit":4,"./color_functions":5}],7:[function(require,module,exports){
"use strict";
...
var WmuColorDisplay = /*#__PURE__*/function (_React$Component) {
  _inherits(WmuColorDisplay, _React$Component);

  var _super = _createSuper(WmuColorDisplay);
  ...
  _createClass(WmuColorDisplay, [{
    ...
    value: function render() {
      return /*#__PURE__*/React.createElement("div", {
        ...
        hex_value: '#442416',
        setParentColor: this.props.setParentColor
      }), /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement(_color_display["default"], {
...
var _default = WmuColorDisplay;
exports["default"] = _default;

},{"./color_display":3,"./color_functions":5}]},{},[1]);
